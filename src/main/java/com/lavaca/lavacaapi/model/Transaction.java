...
public class Transaction {
    ...
    public Transaction(UUID id, UUID vacaId, UUID participantId, int amount, String description, Timestamp date, UUID userId, String type, UUID approvedBy, String paymentMethod) {
        this.id = id;
        this.vacaId = vacaId;
